...
class DaruV4MuJoCoCustomRosBridge {
 public:
  explicit DaruV4MuJoCoCustomRosBridge(DaruV4MuJoCoCustomController& controller,
                                 const std::string& node_name = "daru_v4_mujoco_gr00t_infer_sim",
                                 int wall_timer_hz = 500);
  ~DaruV4MuJoCoCustomRosBridge();
 ...
 private:
  ...
  void PoseGR00TCallback(const sensor_msgs::msg::JointState::SharedPtr msg);

 private:
  DaruV4MuJoCoCustomController& controller_;
  ...
  rclcpp::Subscription<sensor_msgs::msg::JointState>::SharedPtr gr00t_action_sub_;
  rclcpp::Publisher<sensor_msgs::msg::JointState>::SharedPtr gr00t_state_pub_;
